...
date: 2022-11-23
image: /blog/ethereum-payment-processor/cover.png
tags: [ethereum, web3, crypto]
---
...
requires a **ton** of tax information to open a store.
...
how should funds flow from _customer_ to _vendor_.
...
For that, we'll notify vendors of a completed payment via [Webhooks]. 
...
allow them to, we'll add an arbitrary _userdata_ attribute to
...
The _buy_ page will create a new transaction and forward us to the 
_checkout_ page. The checkout page will track the state of the transaction. 
Checkout lets the user know _where_ to send funds, _how much_ to send, and 
_what_ is the state of that transfer.

---

All of this will work for any cryptocurrency, but by using Ethereum we get the 
benefit of working with [Geth].

The source is quite large, so I only want to point out some key functions. 
First lets look at the **buy** API:
...
We could use a Web3 wallet like [Metamask] and
automate a [Uniswap] transaction to convert 
user funds to ETH before transferring them to our vendor. 
With this approach, the gateway could accept **any** Ethereum asset!
...
{/* reference links */}
[DeFi]: https://www.investopedia.com/decentralized-finance-defi-5113835
[Finite-state Machine]: https://en.wikipedia.org/wiki/Finite-state_machine
[Webhooks]: https://www.redhat.com/en/topics/automation/what-is-a-webhook
