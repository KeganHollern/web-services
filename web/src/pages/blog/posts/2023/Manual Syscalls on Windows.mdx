...
> it is executed." - [Wikipedia](https://en.wikipedia.org/wiki/System_call)
...
calls to NtDll functions such as [NtAllocateVirtualMemory](https://learn.microsoft.com/en-us/windows-hardware/drivers/ddi/ntifs/nf-ntifs-ntallocatevirtualmemory). 
They often do this through [inline hooks](https://www.malwaretech.com/2015/01/inline-hooking-for-programmers-part-1.html) 
on those functions, but there are many approaches that can be taken. 
...
- [NtAllocateVirtualMemory](https://undocumented.ntinternals.net/index.html?page=UserMode%2FUndocumented%20Functions%2FMemory%20Management%2FVirtual%20Memory%2FNtQueryVirtualMemory.html)
- [NtProtectVirtualMemory](https://undocumented.ntinternals.net/index.html?page=UserMode%2FUndocumented%20Functions%2FMemory%20Management%2FVirtual%20Memory%2FNtQueryVirtualMemory.html)
- [NtQueryVirtualMemory](https://undocumented.ntinternals.net/index.html?page=UserMode%2FUndocumented%20Functions%2FMemory%20Management%2FVirtual%20Memory%2FNtQueryVirtualMemory.html)
...
To do this, I popped NtDll into [IDA Pro](https://hex-rays.com/ida-pro/) and looked over the disassembly.
...
Knowing the [x64 calling convention](https://learn.microsoft.com/en-us/cpp/build/x64-calling-convention?view=msvc-170), 
I found line #1 curious. It sets the value of `r10` to `rcx`. 
This is because the `syscall` operation [destroys the RCX register](https://stackoverflow.com/a/35619528), 
...
One of the important things to note is that the [shadow space](https://stackoverflow.com/questions/30190132/what-is-the-shadow-space-in-x64-assembly) 
still needs allocated (L26-29) (Note: I call it the "shadow pool" in reference to Dota 2 smurfing).
...
There exists many ways of detecting these, such as [instrumentation callbacks](https://github.com/Deputation/instrumentation_callbacks), 
