...
date: 2023-11-05
image: /blog/escape-from-tarkov-dma-radar/cover.png
tags: [tarkov, dma, cheats]
---

# Escape From Tarkov DMA Radar

> You can buy my Tarkov cheats @ [ECheats]
...
online maps when playing without cheats- so I opted to make use of [tarkov.help].

![map](/blog/escape-from-tarkov-dma-radar/img-1.png)
...
![code](/blog/escape-from-tarkov-dma-radar/img-2.png)

Inspecting the page and we find the canvas has this `leaflet-zoom-animated` class. 
A quick google search and we discover [LeafletJS]. 
...
[Chrome Extension]. With an extension, 
I can write a [content script], 
which will run my custom JavaScript.

Rendering custom icons requires gaining access to the [LeafletJS] _map_ object. 
This wasn't trivial due to the React-based design of Tarkov.help and 
...
![map](/blog/escape-from-tarkov-dma-radar/img-3.png)

To connect our [Chrome Extension] with our DMA device, I opted for a WebSocket.
I wrote [SimpleWS] to make this easy for me.
...
For this, we'll make use of my [MemStream] library.
[MemStream] wraps [MemProcFS], 
...
This will help get my logic across without requiring in-depth knowledge of my 
[MemStream] library or DMA cheating.
...
[tarkov.help]: https://tarkov.help/
[LeafletJS]: https://leafletjs.com/
[Chrome Extension]: https://developer.chrome.com/docs/extensions/
[SimpleWS]: https://github.com/KeganHollern/SimpleWS
