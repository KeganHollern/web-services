...
![buffer example](/blog/dma-code-execution/img-1.png)
...
![code segment](/blog/dma-code-execution/img-2.png)
...
![ticking thread](/blog/dma-code-execution/img-3.png)

Looking at the disassembly, we can happily say this call is 5 bytes in size:

![5-byte call](/blog/dma-code-execution/img-4.png)
...
![before](/blog/dma-code-execution/img-5.png)

becomes

![after](/blog/dma-code-execution/img-6.png)

Now, in our `.text` buffer, we recreate the call that was overwritten:

![before 2](/blog/dma-code-execution/img-7.png)

becomes

![after 2](/blog/dma-code-execution/img-8.png)

Lastly, we must jump back to the instruction proceeding the call that we overwrote:

![jump](/blog/dma-code-execution/img-9.png)
...
![storing volatiles](/blog/dma-code-execution/img-10.png)
...
![data access](/blog/dma-code-execution/img-11.png)
...
![null check](/blog/dma-code-execution/img-12.png)

Finally, we'll move the function we want to execute onto the RAX register.

![rax set](/blog/dma-code-execution/img-13.png)
...
![more null check](/blog/dma-code-execution/img-14.png)

Now we must push our first four arguments onto the correct registers.

![arg registers](/blog/dma-code-execution/img-15.png)
...
![pushing to stack](/blog/dma-code-execution/img-16.png)

Finally! We can call the function.

![calling](/blog/dma-code-execution/img-17.png)

After calling the function, we need to pop the arguments we pushed to the stack.

![popping](/blog/dma-code-execution/img-18.png)
...
![cleanup](/blog/dma-code-execution/img-19.png)
...
![dma program](/blog/dma-code-execution/img-20.png)
