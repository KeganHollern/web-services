...
date: 2022-06-27
image: /blog/modded-proto-definitions-in-enfusion-engine/cover.png
tags: [arma-reforger, enfusion, enscript, modding]
---
...
via [CVE-2016-4802]. This exploit exists in libcurl and causes the game to load 
...
![IDA](/blog/modded-proto-definitions-in-enfusion-engine/img-1.png)
...
![VTABLE](/blog/modded-proto-definitions-in-enfusion-engine/img-2.png)
...
into the global linked list. This is super simple, so I won't describe it 🙂.
...
[CVE-2016-4802]: https://curl.se/docs/CVE-2016-4802.html
