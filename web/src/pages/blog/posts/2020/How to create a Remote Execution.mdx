...
date: 2020-10-19
image: /blog/how-to-create-a-remote-execution/cover.png
...
First Execution:
1. CreateMarker
2. Remote Execute (install payload on server)
3. SetMarkerText (trigger server read)
4. (back to server) Read marker text
5. Execute value on all machines
