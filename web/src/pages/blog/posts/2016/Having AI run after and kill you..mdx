...
description: |
    A tutorial on creating a zombie-like script in ArmA 3 using event handlers to force AI to run and dynamically redirect their pathing towards a player.
...
![img](https://i.gyazo.com/ef07378ca0aeeae44588bcd3fab61def.png)
...
![img](https://i.gyazo.com/cc0bb3f1c66c4c482eaf155d6db9012f.png)

I then added "AI = this" into the ai's init field.

![img](https://i.gyazo.com/0dc0b5ca47bc7e7712b860db65a63550.png)
