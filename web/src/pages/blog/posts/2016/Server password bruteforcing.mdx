...
description: |
    A method for stealing server admin passwords by utilizing an altis life database injection to run a bruteforce script, exploiting the serverCommand missing bad-password limit.
...
Well, thanks to Bohemia Interactive, I didn't have to spend to much time searching. The [wiki page for serverCommand](https://community.bistudio.com/wiki/serverCommand) clearly documents under it's Alternative Syntax that the function returns **TRUE** if the password is valid.

![img](https://i.gyazo.com/8144d48f0111406552b69022ed4d48d9.png)
...
![img](https://i.gyazo.com/201584d31f1ecdd7b0d0d31ff1e7fa04.png)
...
![img](https://i.gyazo.com/7d099767355831cc97b06bd059350ec6.png)
