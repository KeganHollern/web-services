...
date: 2021-05-22
image: /blog/callextension-in-dayz/cover.png
tags: [dayz, enscript, modding]
---
...
![bidebugengine](/blog/callextension-in-dayz/img-1.png)

> Note: shortly after releasing infinity, the developers of DayZ **removed** the code above. 
...
![native init](/blog/callextension-in-dayz/img-2.png)
...
![math lib](/blog/callextension-in-dayz/img-3.png)
...
![minhook](/blog/callextension-in-dayz/img-4.png)

Here we are registering our functions for `callExtension`:

![registration](/blog/callextension-in-dayz/img-5.png)
